# Schéma Google Sheets — 8 Onglets (Référence Complète)
...
| tranches_ir | str | Détail par tranche |
| taux_marginal | float | Taux tranche max atteinte |
| simulation_vl | float | Versement libératoire : `revenu_imposable × 2.2%` |
