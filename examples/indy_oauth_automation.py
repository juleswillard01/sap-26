"""
Example: Automating "Connexion avec Google" on Indy
WITHOUT triggering Cloudflare Turnstile.

This module demonstrates Approach 1 from OAUTH_TURNSTILE_RESEARCH.md:
...
Usage:
    # Discovery phase: Find Indy's OAuth client_id
    python examples/indy_oauth_automation.py --discover

    # Login via OAuth
    python examples/indy_oauth_automation.py --login

    # Use headless mode (reuses saved session)
